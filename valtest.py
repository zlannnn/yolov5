...
def run(
    ...
    myout = np.ones([1,1,1,1,25200,32]), dtype=np.float16)
    for batch_i, (im, targets, paths, shapes) in enumerate(pbar):
        ...
        myout = mf_yolo.inference(myout, myout.nbytes)
        print(myout)
...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/roadsign_voc.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default='/home/kylin/work/dataset_yolov5/MYD_Compressor_EvalPipe_Yolov5_V1.0.1.0/yolov5_16x_mAP0_5_img640_0.941.pt', help='model.pt path(s)')
